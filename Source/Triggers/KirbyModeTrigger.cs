...
namespace Celeste.Triggers
{
    ...
    public class KirbyModeTrigger : Trigger
    {
        ...
        // SFX paths
        private const string SFX_ENABLE = "event:/desolo_zantas/char/kirby/transform_in";
        private const string SFX_DISABLE = "event:/desolo_zantas/char/kirby/transform_out";
