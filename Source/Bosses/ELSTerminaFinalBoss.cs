...
public class ELSTerminaFinalBoss : Actor
{
    ...
    private void PlayActivate() => PlayAudio("event:/desolo_zantas/final_content/char/els/Els_Activate");
    private void PlayBeamSlash() => PlayAudio("event:/desolo_zantas/final_content/char/els/Els_BeamSlash");
    private void PlayBiggerGunFire() => PlayAudio("event:/desolo_zantas/final_content/char/els/Els_Bigger_Gun_Fire");
    private void PlayBigHit() => PlayAudio("event:/desolo_zantas/final_content/char/els/Els_BigHit");
    private void PlayBubble() => PlayAudio("event:/desolo_zantas/final_content/char/els/Els_Bubble");
    private void PlayBuild() => PlayAudio("event:/desolo_zantas/final_content/char/els/Els_Build");
    private void PlayCharge() => PlayAudio("event:/desolo_zantas/final_content/char/els/Els_Charge");
    private void PlayConsume() => PlayAudio("event:/desolo_zantas/final_content/char/els/Els_Consume");
    private void PlayCreate() => PlayAudio("event:/desolo_zantas/final_content/char/els/Els_Create");
    private void PlayCryingDeath() => PlayAudio("event:/desolo_zantas/final_content/char/els/Els_Crying_Death");
    private void PlayDarkmatterSpawn() => PlayAudio("event:/desolo_zantas/final_content/char/els/Els_Darkmatter_Spawn");
    private void PlayFinalCry() => PlayAudio("event:/desolo_zantas/final_content/char/els/Els_Final_Cry");
    private void PlayIdle() => PlayAudio("event:/desolo_zantas/final_content/char/els/Els_Idle");
    private void PlayImpact() => PlayAudio("event:/desolo_zantas/final_content/char/els/Els_Impact");
    private void PlayIntro() => PlayAudio("event:/desolo_zantas/final_content/char/els/Els_Intro");
    private void PlayKnockout() => PlayAudio("event:/desolo_zantas/final_content/char/els/Els_Knockout");
    private void PlayLaugh() => PlayAudio("event:/desolo_zantas/final_content/char/els/Els_Laugh");
    private void PlayPrecreate() => PlayAudio("event:/desolo_zantas/final_content/char/els/Els_Precreate");
    private void PlayPredeath() => PlayAudio("event:/desolo_zantas/final_content/char/els/Els_Predeath");
    private void PlayPreImpact() => PlayAudio("event:/desolo_zantas/final_content/char/els/Els_PreImpact");
    private void PlayRevival() => PlayAudio("event:/desolo_zantas/final_content/char/els/Els_Revival");
    private void PlayRift() => PlayAudio("event:/desolo_zantas/final_content/char/els/Els_Rift");
    private void PlayRiftBullet() => PlayAudio("event:/desolo_zantas/final_content/char/els/Els_Rift_Bullet");
    private void PlayScreamHit() => PlayAudio("event:/desolo_zantas/final_content/char/els/Els_Scream_Hit");
    private void PlayShellScreamer() => PlayAudio("event:/desolo_zantas/final_content/char/els/Els_Shell_Screamer");
    private void PlayShellcrack() => PlayAudio("event:/desolo_zantas/final_content/char/els/Els_Shellcrack");
    private void PlaySlice() => PlayAudio("event:/desolo_zantas/final_content/char/els/Els_Slice");
    private void PlaySpawn() => PlayAudio("event:/desolo_zantas/final_content/char/els/Els_Spawn");
    private void PlayStarDeath() => PlayAudio("event:/desolo_zantas/final_content/char/els/Els_StarDeath");
    private void PlayStarDeathGlitch() => PlayAudio("event:/desolo_zantas/final_content/char/els/Els_StarDeath_Glitch");
    private void PlayTeleport() => PlayAudio("event:/desolo_zantas/final_content/char/els/Els_Teleport");
    private void PlayTimeManipulatorEnd() => PlayAudio("event:/desolo_zantas/final_content/char/els/Els_Time_Manipulator_End");
    private void PlayTimeManipulatorStart() => PlayAudio("event:/desolo_zantas/final_content/char/els/Els_Time_Manipulator_Start");
    private void PlayWoosh() => PlayAudio("event:/desolo_zantas/final_content/char/els/Els_Woosh");
    #endregion
