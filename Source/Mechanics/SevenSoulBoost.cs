...
namespace Celeste.Entities.SoulBoosts
{
    ...
    public class SevenSoulBoost : Entity
    {
        ...
        Level level = Scene as Level;
            ...
            if (finalCh21Boost)
            {
                Audio.Play("event:/pusheen/extra_content/char/madeline/finalfinalfinalultra_part1", Position);
            }
            else if (!finalBoost)
            {
                Audio.Play("event:/pusheen/extra_content/char/madeline/ready", Position);
            }
            else
            {
                Audio.Play("event:/pusheen/extra_content/char/madeline/launch", Position);
            }
            ...
            else
            {
                if (finalCh21Boost)
                {
                    Ch21FinalBoostSfx = Audio.Play("event:/pusheen/extra_content/char/madeline/finalfinalfinalultra_part2", Position);
                }
