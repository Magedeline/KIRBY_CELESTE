...
namespace Celeste.Entities
{
    ...
    public class PopstarBerry : Actor, IStrawberry
    {
        ...
        private const string AudioElaborate  = "event:/desolo_zantas/game/general/strawberry_get";
        ...
        private void OnPlayer(global::Celeste.Player player)
        {
            ...
            Audio.Play("event:/desolo_zantas/game/general/strawberry_get", Position, "colour", 5f);
