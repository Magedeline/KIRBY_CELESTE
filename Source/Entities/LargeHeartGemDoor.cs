...
internal class LargeHeartGemDoor : Entity
{
    ...
    public IEnumerator Routine()
    {
        ...
        if (this.startHidden)
        {
            ...
            Audio.Play("event:/desolo_zantas/final_content/game/19_the_end/large_heart_door", this.Position);
            this.Visible = true;
            this.heartAlpha = 0f;
    ...
    private IEnumerator OpenCutscene(Level level)
    {
        ...
        this.cutsceneMusic = Audio.Play("event:/desolo_zantas/final_content/music/lvl19/cinematic/BEB_cutscenes", this.Position);
