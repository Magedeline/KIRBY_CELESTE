...
public class BarrierBreakController : Entity
{
    ...
    public IEnumerator ExecuteBarrierBreakSequence()
    {
        ...
        {
            Audio.Play("event:/desolo_zantas/final_content/music/lvl20/cinematic/break_fourth_wall_part1");
        ...
        Audio.Play("event:/desolo_zantas/final_content/music/lvl20/cinematic/break_fourth_wall_part2");
        ...
        Audio.Play("event:/desolo_zantas/final_content/music/lvl20/cinematic/break_fourth_wall_part3");
