...
namespace Celeste.Cutscenes
{
  ...
  public class Cs02DreamingPhonecallPortal : CutsceneEntity
  {
    ...
    private IEnumerator cutscene(Level level)
    {
      ...
      this.Add(tween);
      Audio.Play("event:/desolo_zantas/game/02_nightmare/sequence_phone_portal", payphone.Position);
    ...
    public override void OnEnd(Level level)
    {
      ...
      level.Session.Audio.Music.Event = "event:/desolo_zantas/music/lvl2/awake";
      level.Session.Audio.Ambience.Event = "event:/desolo_zantas/env/02_awake";
