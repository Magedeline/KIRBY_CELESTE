...
internal static class ChapterRegistry
{
    ...
    public static void RegisterAllChapters(List<AreaMapData.ChapterDef> chapters)
    {
        ...
        {
            Number = 0, SID = AreaModeExtender.BuildASideSID("00_Prologue"),
        ...
        Register(chapters, new AreaMapData.ChapterDef
        {
            Number = 1, SID = AreaModeExtender.BuildASideSID("01_City"),
        ...
        Register(chapters, new AreaMapData.ChapterDef
        {
            Number = 2, SID = AreaModeExtender.BuildASideSID("02_Nightmare"),
        ...
        Register(chapters, new AreaMapData.ChapterDef
        {
            Number = 3, SID = AreaModeExtender.BuildASideSID("03_Stars"),
        ...
        Register(chapters, new AreaMapData.ChapterDef
        {
            Number = 4, SID = AreaModeExtender.BuildASideSID("04_Legend"),
        ...
        Register(chapters, new AreaMapData.ChapterDef
        {
            Number = 5, SID = AreaModeExtender.BuildASideSID("05_Restore"),
        ...
        Register(chapters, new AreaMapData.ChapterDef
        {
            Number = 6, SID = AreaModeExtender.BuildASideSID("06_Stronghold"),
        ...
        Register(chapters, new AreaMapData.ChapterDef
        {
            Number = 7, SID = AreaModeExtender.BuildASideSID("07_Hell"),
        ...
        Register(chapters, new AreaMapData.ChapterDef
        {
            Number = 8, SID = AreaModeExtender.BuildASideSID("08_Truth"),
        ...
        Register(chapters, new AreaMapData.ChapterDef
        {
            Number = 9, SID = AreaModeExtender.BuildASideSID("09_Summit"),
        ...
        Register(chapters, new AreaMapData.ChapterDef
        {
            Number = 10, SID = AreaModeExtender.BuildASideSID("10_Ruins"),
        ...
        Register(chapters, new AreaMapData.ChapterDef
        {
            Number = 11, SID = AreaModeExtender.BuildASideSID("11_Snow"),
        ...
        Register(chapters, new AreaMapData.ChapterDef
        {
            Number = 12, SID = AreaModeExtender.BuildASideSID("12_Water"),
        ...
        Register(chapters, new AreaMapData.ChapterDef
        {
            Number = 13, SID = AreaModeExtender.BuildASideSID("13_Fire"),
        ...
        Register(chapters, new AreaMapData.ChapterDef
        {
            Number = 14, SID = AreaModeExtender.BuildASideSID("14_Digital"),
        ...
        Register(chapters, new AreaMapData.ChapterDef
        {
            Number = 15, SID = AreaModeExtender.BuildASideSID("15_Castle"),
        ...
        Register(chapters, new AreaMapData.ChapterDef
        {
            Number = 16, SID = AreaModeExtender.BuildASideSID("16_Corruption"),
        ...
        Register(chapters, new AreaMapData.ChapterDef
        {
            Number = 17, SID = AreaModeExtender.BuildASideSID("17_Epilogue"),
        ...
        Register(chapters, new AreaMapData.ChapterDef
        {
            Number = 18, SID = AreaModeExtender.BuildASideSID("18_Heart"),
        ...
        Register(chapters, new AreaMapData.ChapterDef
        {
            Number = 19, SID = AreaModeExtender.BuildASideSID("19_Space"),
        ...
        Register(chapters, new AreaMapData.ChapterDef
        {
            Number = 20, SID = AreaModeExtender.BuildASideSID("20_TheEnd"),
        ...
        Register(chapters, new AreaMapData.ChapterDef
        {
            Number = 21, SID = AreaModeExtender.BuildASideSID("21_LastLevel"),
