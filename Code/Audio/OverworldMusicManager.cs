...
public static class OverworldMusicManager
{
    ...
    {
        // Delegate to AudioBankLoader which handles FMOD 1.10.20 bank loading
        // directly via Audio.System.loadBankFile, bypassing Everest's auto-loader
        // that throws ERR_FILE_NOTFOUND when a .strings.bank is absent.
        AudioBankLoader.Load();
    }
    ...
    {
        if (!AudioBankLoader.IsLoaded) AudioBankLoader.Load();
