...
lostSoul.name = "MaggyHelper/LostSoul"
...
lostSoul.placements = {
    {
        ...
        data = {
            ...
            floatingSpeed = 1.0,
            glowIntensity = 0.8,
            dialogKey = "MAGGYHELPER_CH16_LOST_SOULS_1", 
            message = "Help... us...",
    ...
    },
    {
        ...
        data = {
            ...
            floatingSpeed = 0.8,
            glowIntensity = 1.0,
            dialogKey = "MAGGYHELPER_CH16_LOST_SOULS_2",
    ...
    },
    {
        ...
        data = {
            ...
            floatingSpeed = 1.2,
            glowIntensity = 1.0,
            dialogKey = "MAGGYHELPER_CH16_LOST_SOULS_3",
    ...
    },
    {
        ...
        data = {
            ...
            floatingSpeed = 0.9,
            glowIntensity = 1.0,
            dialogKey = "MAGGYHELPER_CH16_LOST_SOULS_4",
    ...
    },
    {
        ...
        data = {
            ...
            floatingSpeed = 0.7,
            glowIntensity = 1.0,
            dialogKey = "MAGGYHELPER_CH16_LOST_SOULS_5",
    ...
    },
    {
        ...
        data = {
            ...
            floatingSpeed = 1.1,
            glowIntensity = 1.0,
            dialogKey = "MAGGYHELPER_CH16_LOST_SOULS_6",
            message = "Please... remember us...",
            autoCollectable = false,
            requiresInteraction = true,
            enableParticles = true,
    ...
    },
    {
        ...
        data = {
            ...
            floatingSpeed = 1.0,
            glowIntensity = 1.0,
            dialogKey = "MAGGYHELPER_CH16_LOST_SOULS_7",
    ...
    },
    {
        ...
        data = {
            ...
            floatingSpeed = 1.3,
            glowIntensity = 1.2,
            dialogKey = "MAGGYHELPER_CH16_LOST_SOULS_8",
...
lostSoul.fieldInformation = {
    ...
    dialogKey = {
        fieldType = "string",
        options = {
            "MAGGYHELPER_CH16_LOST_SOULS_1",
            "MAGGYHELPER_CH16_LOST_SOULS_2",
            "MAGGYHELPER_CH16_LOST_SOULS_3",
            "MAGGYHELPER_CH16_LOST_SOULS_4",
            "MAGGYHELPER_CH16_LOST_SOULS_5",
            "MAGGYHELPER_CH16_LOST_SOULS_6",
            "MAGGYHELPER_CH16_LOST_SOULS_7",
            "MAGGYHELPER_CH16_LOST_SOULS_8"
        }
    },
    message = {
        fieldType = "string"
